...
const Home: React.FC = () => {
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-animate py-16 lg:py-32">
        <div className="absolute inset-0 opacity-20">
          <div className="light-beam"></div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div data-reveal="true" className="reveal-left">
              <div className="inline-flex items-center space-x-2 bg-teal-100 text-teal-700 px-4 py-1.5 rounded-full mb-6 font-bold text-xs uppercase tracking-widest hover-lift magnetic-btn">
                <GraduationCap className="w-4 h-4 rotate-slow" />
              ...
              <h1 className="text-4xl lg:text-6xl font-extrabold text-slate-900 mb-8 leading-tight">
                Dashrath Prasad Ramnandan Pandey <span className="magic-text">College of Pharmacy</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link to="/academics/admission" className="px-10 py-4 bg-teal-600 text-white font-bold rounded-full text-center shadow-xl shadow-teal-600/20 hover:bg-teal-700 transition-all transform hover:-translate-y-1 hover-lift magnetic-btn button-pulse">
                  Apply Online
                </Link>
                <Link to="/academics/courses" className="px-10 py-4 bg-white text-teal-600 border-2 border-teal-600 font-bold rounded-full text-center hover:bg-teal-50 transition-all hover-lift magnetic-btn button-pulse">
                  Explore Programs
                </Link>
              </div>
            </div>
            <div className="relative reveal-right" data-reveal="true">
              <div className="absolute -inset-4 bg-teal-100 rounded-3xl blur-2xl opacity-50 -z-10 scale-pulse"></div>
              <div className="grid grid-cols-2 gap-4">
                <img 
                  src="https://picsum.photos/id/101/600/800" 
                  alt="Modern Lab" 
                  className="rounded-3xl shadow-2xl h-96 object-cover transform -rotate-3 hover:rotate-0 transition-transform duration-500 card-hover float-3d"
                />
                <div className="space-y-4 pt-12">
                  <img 
                    src="https://picsum.photos/id/201/600/600" 
                    alt="Research" 
                    className="rounded-3xl shadow-2xl h-48 w-full object-cover card-hover hover:scale-105 transition-transform"
                  />
                  <div className="bg-teal-600 rounded-3xl p-8 text-white shadow-xl flex flex-col justify-center aspect-square glow-pulse">
      ...
      <section className="py-20 bg-white border-y border-slate-100 relative overflow-hidden">
        <div className="light-beam opacity-30"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center group fade-in-stagger card-hover" data-reveal="true">
                <div className="inline-flex p-4 rounded-2xl bg-slate-50 text-teal-600 mb-6 group-hover:bg-teal-600 group-hover:text-white transition-all duration-300 scale-pulse">
                  <stat.icon className="w-8 h-8" />
                </div>
                <h4 className="text-4xl font-black text-slate-900 mb-2 rainbow-text">{stat.value}</h4>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 reveal-up" data-reveal="true">
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight magic-text">Our Premier Courses</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group fade-in-stagger card-hover" data-reveal="true">
                ...
                <div className="p-8">
                  <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:magic-text transition-all">{course.title}</h3>
                  <p className="text-slate-600 mb-6 line-clamp-3 leading-relaxed">{course.desc}</p>
                  <Link to="/academics/courses" className="inline-flex items-center text-teal-600 font-bold hover:text-teal-700 group magnetic-btn">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-8">
              {[1, 2].map((n) => (
                <div key={n} className="flex flex-col sm:flex-row gap-8 items-center group fade-in-stagger card-hover" data-reveal="true">
                  <div className="w-full sm:w-64 h-48 rounded-2xl overflow-hidden shadow-lg relative">
                    <div className="light-beam opacity-30"></div>
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:magic-text transition-all">New Breakthrough in Oncology Nanoparticles</h3>
            ...
            <div className="space-y-6" data-reveal="true">
              <div className="bg-gradient-animate rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden card-hover glow-pulse">
                ...
                <div className="relative z-10">
                  <h4 className="text-xl font-bold mb-4">Full Calendar</h4>
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { title: 'Summit 2023', date: 'Nov 12', img: '101', desc: 'Pharmacy' },
                      { title: 'White Coat', date: 'Nov 15', img: '102', desc: 'Ceremony' },
                      { title: 'Ethics Workshop', date: 'Nov 20', img: '103', desc: 'Trials' },
                    ].map((event, i) => (
                      <div key={i} className="group cursor-pointer">
                        <div className="relative h-32 rounded-lg overflow-hidden mb-2 bg-white/10">
                          <img 
                            src={`https://picsum.photos/id/${event.img}/200/200`} 
                            alt={event.title}
                ...
                <button className="mt-6 w-full py-3 bg-white text-teal-600 font-bold rounded-2xl hover:bg-teal-50 transition-all magnetic-btn hover-lift button-pulse relative z-10">
                  View Full Calendar →
                </button>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-animate rounded-[4rem] px-8 py-20 text-center text-white relative overflow-hidden card-hover glow-pulse">
            <div className="light-beam opacity-30"></div>
